...
class ElderlySignUpScreen extends StatefulWidget {
  ...
  const ElderlySignUpScreen({super.key, this.onSignUpSuccess});
...
class _ElderlySignUpScreenState extends State<ElderlySignUpScreen> {
  ...
  void _submit() {
    ...
    // TODO: 실제 회원가입 로직 (userType: 'elderly')
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('어르신 회원가입 완료!')),
    );
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => ElderlyLoginScreen(
